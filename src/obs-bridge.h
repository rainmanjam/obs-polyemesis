...
typedef struct {
	...
	bool show_vertical_notification; /* Show notification when vertical canvas detected */
...
typedef void (*obs_bridge_status_callback_t)(obs_bridge_status_t status, void *user_data);
